...
<div class="met-seo-link">
  <div class="d-flex justify-content-between">
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".link-add-modal"
      ...
      data-modal-title="{$word.mobiletips3}" data-modal-tablerefresh="#seo-link-table">
      {$word.mobiletips3}
    </button>
    <div>
      <!-- 筛选 -->
      ...
      <div class="input-group w-a float-left">
        <input type="search" name="keyword" placeholder="{$word.search}" class="form-control" data-table-search="#seo-link-table" />
  ...
  <table class="dataTable table table-hover w-100 mt-2 link-table"
    data-ajaxurl="{$url.admin}?n=link&c=link_admin&a=doGetList" data-table-pagelength="20" data-plugin="checkAll"
    id="seo-link-table"
    data-time="{$time}"
    data-datatable_order="#seo-link-table">
    <thead>
      <tr>
