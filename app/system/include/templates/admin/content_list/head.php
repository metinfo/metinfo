...
<div class="clearfix">
	...
	<div class="float-right">
		...
		<div data-plugin='select-linkage' data-select-url="json" data-required="1" class="d-inline-block mr-2 column-select">
		...
		<div class="input-group w-a<if value="!$head_add_none">float-right<else/>float-left</if>">
