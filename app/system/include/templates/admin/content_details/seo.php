...
?>
<h3 class='example-title clearfix'><span class="my-1 d-inline-block">SEO{$word.seting}</span><button type='button' data-toggle="collapse" data-target=".{$data.n}-details-seo" class='btn btn-default btn-sm float-right'>{$word.moreSettings}<i class="icon fa-angle-right ml-2"></i></button></h3>
