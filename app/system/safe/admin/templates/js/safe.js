        ...
        M.ajax({
            ...
            function (result) {
                ...
                Object.keys(data).map(item => {
                    if ($.inArray(item, ['met_img_rename', 'met_logs', 'met_login_code', 'met_memberlogin_code', 'disable_cssjs', 'met_auto_play_pc', 'met_auto_play_mobile', 'met_info_security_statement_open']) >= 0) {
