		...
		<header class="metadmin-head navbar bg-white px-0 py-3" style="z-index: 1001;">
			<div class="container-fluid px-4">
		        ...
		        <div class="metadmin-head-right d-flex align-items-center">
	                ...
	                <a href="javascript:;" class="text-content mr-4" data-toggle="modal" data-target=".function-ency-modal" data-modal-size="lg" data-modal-url="#pub/function_ency/?n=index&c=index&a=get_auth" data-modal-refresh="one" data-modal-fullheight="1" data-modal-title="{$word.funcCollection}" data-modal-oktext="" data-modal-notext="{$word.close}">
		            ...
		            <div class="btn-group mr-4">
		                ...
		                <ul class="dropdown-menu dropdown-menu-right">
							...
							<if value="$c['met_agents_metmsg']">
							<a href="javascript:;" class='dropdown-item px-3' data-toggle="modal" data-target=".syslicense-modal" data-modal-url="ui_set/license/?n=index&c=index&a=get_plugins_license" data-modal-title="许可协议">许可协议</a>
							</if>
							</if>
		                </ul>
		            </div>
