	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-12 col-lg-10 col-xl-9 d-flex justify-content-between align-items-center">
				...
				<div class="text-white h5 mb-0">MetInfo|米拓企业建站系统 7.2.0 <font>全新安装</font></div>
			</div>
		</div>
	</div>
</div>
...
echo <<<EOT
-->
<div class="text-center mb-3">Powered by <b><a href="https://www.metinfo.cn" target="_blank">MetInfo 7.2.0</a></b> &copy;2009-$nowyear &nbsp;<a href="https://www.mituo.cn" target="_blank">mituo.cn</a></div>
<!--
EOT;
