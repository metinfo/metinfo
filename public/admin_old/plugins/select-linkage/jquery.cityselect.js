...
(function($){
	$.fn.citySelect=function(settings){
        ...
        var select_prehtml = (settings.required) ? "" : "<option value=''>" + METLANG.Choice + "</option>";
		...
		var cityStart=function(){
			...
			$.each(city_json.citylist[prov_id].c,function(i,city){
				...
				var tv = typeof city.n.value!='undefined'?city.n.value:city.n;
		...
		var distStart=function(){
			...
			$.each(city_json.citylist[prov_id].c[city_id].a,function(i,dist){
				...
				var tv = typeof dist.s.value!='undefined'?dist.s.value:dist.s;
				temp_html+="<option value='"+tv+"'>"+tn+"</option>";
			});
        ...
        var init=function(){
            // 遍历赋值省份下拉列表
            temp_html = select_prehtml;
            METLANG.Choice = METLANG.Choice ? METLANG.Choice : "请选择";
            $.each(city_json.citylist,function(i,prov){
				var tn = prov.p.name?prov.p.name:prov.p;
				var tv = prov.p.value||prov.p.value==''?prov.p.value:prov.p;
                temp_html += prov.p == METLANG.Choice ? "<option value=''>" + tn + "</option>" : "<option value='" + tv + "'>" + tn + "</option>";
			});
